...
dataset_dir="../data/MulDiGraph_smote/delay_5"
result_dir="../result/MulDiGraph_smote/delay_5"
...
for sub_dir_name in $folder_list; do
    ...
    if [ -d "$data_dir" ]; then
        ...
        python gen_finetune_data_smote.py --data_dir="$data_dir" --vocab_file_name="$dataset_dir/1/vocab"
        if [ $? -ne 0 ]; then
