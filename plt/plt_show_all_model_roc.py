...
def plot_all_models_mean_roc(mean_roc_data, result_dir):
    ...
    for idx, (model_name, mean_tpr) in enumerate(mean_roc_data.items()):
        ...
        plt.plot(np.linspace(0, 1, 100), mean_tpr, color=colors[idx % len(colors)],
                 lw=2, alpha=.8, label=f'{model_name} Mean ROC (AUC = {mean_auc:.2f} ± {std_auc:.2f})')
    ...
    plt.title('Mean ROC Curves for All Models')
    plt.legend(loc="lower right")

    # 保存最终的图像
    combined_roc_file = os.path.join(result_dir, 'combined_mean_roc_curve.png')
...
def main():
    ...
    model_name_list = ["ensemble_GCN_gpt-4o-mini_500", "ensemble_GCN_gpt-4o-mini_1000", "ensemble_GCN_gpt-4o-mini_2000", "ensemble_GCN_gpt-4o-mini_500_1000", "ensemble_GCN_gpt-4o-mini_500_2000", "ensemble_GCN_gpt-4o-mini_1000_2000", "ensemble_GCN_gpt-4o-mini_500_1000_2000"]
