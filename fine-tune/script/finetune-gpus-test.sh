...
# nohup ./finetune-gpus-test.sh >> finetune.log 2>&1 &
# ./finetune-gpus-test.sh 2>&1 | tee finetune.log
...
for i in $(seq ${first_partition} ${end_partition}); do
    ...
    # python -u /root/prompt/single_expert/llama_finetune_prompt_batch_cot_2_vllm_multiprocess.py \
    #     --model_path "/root/autodl-tmp/Llama-3.1-8B_MulDiGraph_delay_5_8_SFT" \
    #     --dataset_name "MulDiGraph" \
    #     --delay 5 \
    #     --strategy "purest" \
    #     --test_dir "/root/data/clustered_graphs" \
    #     --result_dir "/root/result_multiprocess/llama_finetune/finetune_cot_2" \
    #     --index 8 \
    #     --multiple 500 \
    #     --gpu_count 2
