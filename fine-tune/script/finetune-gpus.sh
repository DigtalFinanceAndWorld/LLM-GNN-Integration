...
finetune_dataset_dir="/root/LLaMA-Factory/data/${finetune_type}"
...
result_dir="/root/result_multiprocess/llama_finetune/${finetune_type}"
gpu_count=8
...
for i in $(seq ${first_partition} ${end_partition}); do
    ...
    # llamafactory-cli export \
    #     --model_name_or_path /root/autodl-tmp/Llama-3.1-8B_MulDiGraph_delay_5_4_SFT \
    #     --adapter_name_or_path "/root/autodl-tmp/adapter/5" \
    #     --template llama3 \
    #     --finetuning_type lora \
    #     --export_dir /root/autodl-tmp/Llama-3.1-8B_MulDiGraph_delay_5_5_SFT \
    #     --export_size 2 \
    #     --export_device cpu \
    #     --export_legacy_format false
    ...
    python -u /root/prompt/single_expert/llama_finetune_prompt_batch_cot_3_vllm_multiprocess.py \
    ...
    # python -u /root/prompt/single_expert/llama_finetune_prompt_batch_cot_3_vllm_multiprocess.py \
    #     --model_path "/root/autodl-tmp/Llama-3.1-8B_MulDiGraph_delay_5_8_SFT" \
    #     --dataset_name "MulDiGraph" \
    #     --delay 5 \
    #     --strategy "purest" \
    #     --test_dir "/root/data/clustered_graphs" \
    #     --result_dir "/root/result_multiprocess/llama_finetune/finetune_cot_3_smote" \
    #     --index 8 \
    #     --multiple 1000 \
    #     --gpu_count 8
