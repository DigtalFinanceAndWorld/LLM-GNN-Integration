...
# origin_path = '../../dataset/finetune/finetune_analysis_score'
# new_path = '../../dataset/finetune/finetune_analysis_score_smote'

origin_path = '../../dataset/finetune/finetune_analysis_beatllm'
new_path = '../../dataset/finetune/finetune_analysis_beatllm_smote'
