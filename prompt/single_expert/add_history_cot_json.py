...
import transformers
from describe_single_node_testing_token_cot_json import *
import pandas as pd
...
[Instruction]
{
  ...
  "task": {
    "description": "I will provide you with information about a **Target Node** and its true label (**Phishing** or **Non-phishing**). Your task is to analyze the node's behavior and explain why it has been classified with the given label.",
    "details": {
  ...
  "output_format": {
    ...
    "analysis": "Provide a concise analysis using the Chain-of-Thought (CoT) methodology."
    "example": {
        "label": "1 or 0",
        "analysis": "The analysis of Node ... or The 'Target Node' exhibits ..."
    }   
  }
}
