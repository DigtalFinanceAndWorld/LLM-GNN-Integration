...
def expert_A_model(train_node_detail, new_node_detail, message_task_A, message_rule, message_attention_A,
                   messages_system_A):
    print("\nWait for llm expert ...\n")
    messages_input_A = f"""
[Examples]
The following are some example nodes analysis, including both phishing nodes and normal nodes, provided for comparative learning.
...
Learn from the following examples to understand the characteristics of phishing nodes and normal nodes.
Your analysis should be like what is shown below:
{train_node_detail}
...
def expert_debate_model(test_node_detail, response_A, message_task_debater,
                        message_rule, message_attention, messages_system_debater):
    print("\nWait for llm expert ...\n")
    messages_input = f"""
[TASK]
I will provide you with the details of a 'Target Node' along with an analysis conducted by another expert. Please carefully review the 'Target Node' information and critically evaluate the expert’s analysis. Pay attention to both the transactional characteristics of the node and the reasoning provided in the expert’s evaluation.
...
[Evaluation]
{message_task_debater}
{message_rule}
{message_attention}
    """
    messages = [
        {"role": "system", "content": messages_system_debater},
...
def expert_judge_model(test_node_detail, response_A, response_debater, message_task_judge, message_rule,
...
Expert A Analysis: {response_A}

Expert B Analysis: {response_debater}
...
def main():
    ...
    for index in sorted_dataset_list:
        ...
        result_dir = f'../result/{test_type}/{agent}/{dataset_name}/{multiple}/delay_{delay}/{strategy}_debate'
        ...
        # 引入prompt
        prompts_file_path = "../prompt/MultiAgent_debate.json"
        ...
        # --------debater------------
        # debater
        message_task_debater = prompts['task_debater']
        messages_system_debater = prompts['system_debater']
        ...
        for i, node in enumerate(graph_test.nodes):
            ...
            while True:
                try:
                    ...
                    print(f"========================== Expert: debater ==========================")
                    messages_debater, response_debater = expert_debate_model(test_node_detail,
                                                                             response_A, message_task_debater,
                                                                             message_rule,
                                                                             message_attention, messages_system_debater)
                    print("Expert debater success !!!")
                    print(f"========================== Expert: judge ==========================")
                    messages_judge, response_judge = expert_judge_model(test_node_detail, response_A, response_debater,
                                                                        message_task_judge,
